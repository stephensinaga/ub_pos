                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-2">
                                        <select class="form-control" name="entri" aria-placeholder="pilih jumlah">
                                            <option value="10" {{ request('entri') == '10' ? 'selected' : '' }}>10
                                            </option>
                                            <option value="25" {{ request('entri') == '25' ? 'selected' : '' }}>25
                                            </option>
                                            <option value="50" {{ request('entri') == '50' ? 'selected' : '' }}>50
                                            </option>
                                            <option value="100" {{ request('entri') == '100' ? 'selected' : '' }}>100
                                            </option>
